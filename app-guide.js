...
var APP_DOKODEMO_JOY_GUIDE = {
  introPanelStyle: 'featured',
  introBullets: [
    '全国のJOYFIT系店舗を相互利用できるサービスです',
    '登録店舗での簡単な手続きが必要です（無料）',
  ...
  sections: [
    {
      title: '他店舗の利用料金',
      flowItems: [
        { title: 'JOYFIT / JOYFIT24同士', detail: '無料' },
        { title: 'JOYFIT YOGAの利用', detail: '税込3,300円/日（女性限定）※YOGA会員同士は無料' },
        { title: 'JOYFIT+の利用', detail: '原則不可（契約内容は登録店舗へ）' }
      ],
      note: '一部店舗は利用不可・別途料金あり。事前に店舗へご確認ください'
    },
    {
      title: '有料エリア',
      flowItems: [
        { title: '女性専用エリア・ホットスタジオ', detail: '税込550円/日' },
        { title: 'JOYFIT YOGA・特別有料エリア', detail: '税込3,300円/日' }
      ],
      note: 'ICタッチで都度課金（翌月引き落とし）。対象は「有料エリアOK」表示の施設'
    },
    {
      title: '移籍の条件',
      lead: '他店利用が多い場合、登録店舗が移籍されることがあります（入会6ヶ月未満は対象外）',
      flowItems: [
        { title: 'いちばん多い利用が登録店舗以外' },
        { title: 'その他店の利用が月5回以上' },
        { title: 'その他店の利用時間が全体の51%以上' }
      ],
      note: '3条件すべて該当で移籍対象。あんしんサポート以外のオプションは自動解除'
    }
  ]
};
